...
\date{November 19, 2018 draft}

\begin{document}

% Don’t include page numbers on pages with the title and table of contents.
...
% Put as much vertical space as possible between the table of contents and the
% editorial note.
\vfill
...
Code}, often in explanatory margin notes \marginnote{This is a margin
note.} (example at right). Unless otherwise noted, references to the
...
% Begin the content of the bylaws on a new page with Arabic page numbers.
\newpage
...
The following officers shall be elected \marginnote{Eligibility requirements are
in \StatutoryCodeReference{3}{2}.} to administer the affairs of the Chapter. In
...
In addition to the duties \marginnote{\ConstitutionReference{4}{6} describes
duties of members.} prescribed by the Laws of the Fraternity, each Collegiate
...
\begin{subsubsectionList}
  ...
  \minimumGradePointAverage. \marginnote{\StatutoryCodeReference{7}{8}
  prescribes automatic scholastic probation, and then suspension, to members who
  do not maintain the minimum grade point average. These bylaws prescribe
  additional discipline in item~D of Section~\ref{Individual Obligations}.}
...
% The U-M Center for Campus Involvement requires that student organization
% governing documents contain the “Process to become a member”.
...
\begin{subsubsectionList}
  ...
  \begin{orderedList}
    % Code 4‑3 requires that “[t]he number of favorable votes necessary to
    % accept a prospective Associate Member shall be determined by the Chapter
    % in its bylaws…”.
  ...
  % Code 4‑9 requires that “[t]he number of favorable votes necessary to accept
  % a candidate for initiation shall be determined by the Chapter in its
  % bylaws…”. Code 4‑6(a) requires that “[t]he number of votes necessary to
  % continue Associate Membership shall be the same as the number required by
  % the Chapter bylaws to accept a candidate for initiation at the time of the
  % final vote for initiation”, so define a command for the proportion of votes.
  ...
  % Code 4‑4(b) says that a man must “have obtained a scholastic average (GPA)
  % that shall be determined by the Chapter in its bylaws” in “the previous
  % grading period” to be eligible for membership.
  \item {\titleStyle Minimum Grade Point Average\titleSuffix}
  A man who obtained a grade point average \marginnote{Additional scholastic
  requirements for membership are in \StatutoryCodeReference{4}{4}.} of less
  ...
  % Code 5‑3(g) requires this language in chapter bylaws.
  ...
  % This exact wording is required by the U-M Center for Campus Involvement.
  Upon joining the organization, all members agree not to undermine the purpose
  or mission of Sigma.

  % The U-M Center for Campus Involvement requires that student organization
  % governing documents contain the “Process to remove members”.
  \item {\titleStyle Termination of Associate Membership\titleSuffix}
  Associate membership may be terminated \marginnote{
  \StatutoryCodeReference{4}{6} describes conditions for termination of
  Associate Membership.} at any time by the active members of the Chapter. A
  ...
  Any Member who presents his written resignation \marginnote{
  \ConstitutionReference{7}{7} describes resigning.} from the Fraternity
  shall be considered automatically expelled from the Fraternity, with the same
  consequences set forth in \StatutoryCodeReference{7}{1(a)}.
\end{subsubsectionList}
...
In accordance with \ConstitutionReference{4}{6(d)}, every member in good
...
% This exact wording is required by the U-M Center for Campus Involvement. This
% wording is similar to what appears at
% https://hr.umich.edu/working-u-m/workplace-improvement/office-institutional-equity/nondiscrimination-policy-notice.
Sigma \marginnote{Lambda Chi Alpha is a nonprofit men’s social fraternity. The
United States Department of Education’s Office for Civil Rights describes
Title~IX exemptions at
\url{https://www2.ed.gov/about/offices/list/ocr/docs/t9-rel-exempt/index.html}.}
...
the judiciary procedure set by our nationals in \ConstitutionReference{7}{4–6}
...
A review of these bylaws in accordance with \ConstitutionReference{3}{3(a)(7)}
shall occur in the fall after a meeting of the General Assembly. \marginnote{
Meetings of Lambda Chi Alpha’s General Assembly generally occur biennially, in
even-numbered years.}
